      ...
      <div class="print-wrapper">
        ...
        <div class="row">
          ...
          <div class="col row padding-horiz--none skills-list print-content-col">
            <p class="col print-description">Degreed software technical writer with nearly a decade of experience writing for developer audiences, focusing on cloud and Kubernetes, specializing in docs-as-code approaches, and supporting those efforts with front end web development skills.</p>
          </div>
        </div>
        <ResumeExperience />
        <ResumeEducation />
